...
#define kassert_eq(EXPR1, EXPR2)                                               \
    do {                                                                       \
        ...
        if (unlikely(_expr1 != _expr2)) {                                      \
            _Generic((EXPR1),                                                  \
                char: _report_kassert_eq_failed("%c", #EXPR1, #EXPR2,          \
                                                (char)_expr1, (char)_expr2),   \
                unsigned char: _report_kassert_eq_failed(                      \
                         "%u", #EXPR1, #EXPR2, (unsigned char)_expr1,          \
                         (unsigned char)_expr2),                               \
                int: _report_kassert_eq_failed("%d", #EXPR1, #EXPR2,           \
                                               (int)_expr1, (int)_expr2),      \
                unsigned int: _report_kassert_eq_failed("%u", #EXPR1, #EXPR2,  \
                                                        (unsigned int)_expr1,  \
                                                        (unsigned int)_expr2), \
                long: _report_kassert_eq_failed("%ld", #EXPR1, #EXPR2,         \
                                                (long)_expr1, (long)_expr2),   \
                unsigned long: _report_kassert_eq_failed(                      \
                         "%lu", #EXPR1, #EXPR2, (unsigned long)_expr1,         \
                         (unsigned long)_expr2),                               \
                long long: _report_kassert_eq_failed("%lld", #EXPR1, #EXPR2,   \
                                                     (long long)_expr1,        \
                                                     (long long)_expr2),       \
                unsigned long long: _report_kassert_eq_failed(                 \
                         "%llu", #EXPR1, #EXPR2, (unsigned long long)_expr1,   \
                         (unsigned long long)_expr2),                          \
                char *: _report_kassert_eq_failed(                             \
                         "%s", #EXPR1, #EXPR2, (char *)(unsigned long)_expr1,  \
                         (char *)(unsigned long)_expr2),                       \
                void *: _report_kassert_eq_failed("0x%016lx", #EXPR1, #EXPR2,  \
                                                  (unsigned long)_expr1,       \
                                                  (unsigned long)_expr2),      \
                default: _report_kassert_eq_failed("0x%016lx", #EXPR1, #EXPR2, \
                                                   (unsigned long)_expr1,      \
                                                   (unsigned long)_expr2));    \
        }                                                                      \
    } while (false)
