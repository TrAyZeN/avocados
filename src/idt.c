...
void load_idt(void) {
    ...
    idt[33] = GATE_DESCRIPTOR((uint64_t)isr_33, GATE_TYPE_INT);
    idt[34] = GATE_DESCRIPTOR((uint64_t)isr_34, GATE_TYPE_INT);
    idt[35] = GATE_DESCRIPTOR((uint64_t)isr_35, GATE_TYPE_INT);
    idt[36] = GATE_DESCRIPTOR((uint64_t)isr_36, GATE_TYPE_INT);
    idt[37] = GATE_DESCRIPTOR((uint64_t)isr_37, GATE_TYPE_INT);
    idt[38] = GATE_DESCRIPTOR((uint64_t)isr_38, GATE_TYPE_INT);
    idt[39] = GATE_DESCRIPTOR((uint64_t)isr_39, GATE_TYPE_INT);
    idt[40] = GATE_DESCRIPTOR((uint64_t)isr_40, GATE_TYPE_INT);
    idt[41] = GATE_DESCRIPTOR((uint64_t)isr_41, GATE_TYPE_INT);
    idt[42] = GATE_DESCRIPTOR((uint64_t)isr_42, GATE_TYPE_INT);
    idt[43] = GATE_DESCRIPTOR((uint64_t)isr_43, GATE_TYPE_INT);
    idt[44] = GATE_DESCRIPTOR((uint64_t)isr_44, GATE_TYPE_INT);
    idt[45] = GATE_DESCRIPTOR((uint64_t)isr_45, GATE_TYPE_INT);
    idt[46] = GATE_DESCRIPTOR((uint64_t)isr_46, GATE_TYPE_INT);
    idt[47] = GATE_DESCRIPTOR((uint64_t)isr_47, GATE_TYPE_INT);
    idt[48] = GATE_DESCRIPTOR((uint64_t)isr_48, GATE_TYPE_INT);
    idt[49] = GATE_DESCRIPTOR((uint64_t)isr_49, GATE_TYPE_INT);
    idt[50] = GATE_DESCRIPTOR((uint64_t)isr_50, GATE_TYPE_INT);
    idt[51] = GATE_DESCRIPTOR((uint64_t)isr_51, GATE_TYPE_INT);
    idt[52] = GATE_DESCRIPTOR((uint64_t)isr_52, GATE_TYPE_INT);
    idt[53] = GATE_DESCRIPTOR((uint64_t)isr_53, GATE_TYPE_INT);
    idt[54] = GATE_DESCRIPTOR((uint64_t)isr_54, GATE_TYPE_INT);
    idt[55] = GATE_DESCRIPTOR((uint64_t)isr_55, GATE_TYPE_INT);
    idt[56] = GATE_DESCRIPTOR((uint64_t)isr_56, GATE_TYPE_INT);
    idt[57] = GATE_DESCRIPTOR((uint64_t)isr_57, GATE_TYPE_INT);
    idt[58] = GATE_DESCRIPTOR((uint64_t)isr_58, GATE_TYPE_INT);
    idt[59] = GATE_DESCRIPTOR((uint64_t)isr_59, GATE_TYPE_INT);
    idt[60] = GATE_DESCRIPTOR((uint64_t)isr_60, GATE_TYPE_INT);
    idt[61] = GATE_DESCRIPTOR((uint64_t)isr_61, GATE_TYPE_INT);
    idt[62] = GATE_DESCRIPTOR((uint64_t)isr_62, GATE_TYPE_INT);
    idt[63] = GATE_DESCRIPTOR((uint64_t)isr_63, GATE_TYPE_INT);
